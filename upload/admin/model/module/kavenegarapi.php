<?php 
class ModelModuleKavenegarApi extends Model {
	...
	public function formatNumber($number) {
	  ...
	  $this->load->model('extension/event');
		...
		if (version_compare(VERSION, '2.2.0.0', ">=")) {
		   	$this->model_extension_event->addEvent("kavenegarapi", 'catalog/controller/checkout/success/before', 'module/kavenegarapi/onCheckout');
	    	$this->model_extension_event->addEvent("kavenegarapi", 'catalog/model/checkout/order/addOrderHistory/after', 'module/kavenegarapi/onHistoryChange');
	    	$this->model_extension_event->addEvent("kavenegarapi", 'catalog/model/account/customer/addCustomer/after', 'module/kavenegarapi/onRegister');	   	
	   } else {
		   	$this->model_extension_event->addEvent('kavenegarapi', 'post.order.add', 'module/kavenegarapi/onCheckout');
	    	$this->model_extension_event->addEvent('kavenegarapi', 'post.order.history.add', 'module/kavenegarapi/onHistoryChange');
	    	$this->model_extension_event->addEvent('kavenegarapi', 'post.customer.add', 'module/kavenegarapi/onRegister');
	   }
  	} 
