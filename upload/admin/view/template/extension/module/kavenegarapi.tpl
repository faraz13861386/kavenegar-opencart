    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"> <img src="view/template/extension/module/kavenegarapi/logo.png" style="height: 50px;" /> <span style="vertical-align:middle;font-weight:bold;"><?php echo $heading_title; ?></span></h3>
                	...
                	<div class="form-group">
                    	...
                    	<ul class="dropdown-menu" role="menu">
                        	<?php foreach ($stores  as $st) { ?>
                        		<li><a href="index.php?route=extension/module/kavenegarapi&store_id=<?php echo $st['store_id'];?>&token=<?php echo $token; ?>"><?php echo $st['name']; ?></a></li>
                        	<?php } ?> 
                    	</ul>
                	</div>
                </div>
                    ...
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"> 
                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div id="bulksmssend" class="tab-pane active"><?php require_once(DIR_APPLICATION.'view/template/extension/module/kavenegarapi/tab_bulksmssend.php'); ?></div>
                                <div id="actions" class="tab-pane fade"><?php require_once(DIR_APPLICATION.'view/template/extension/module/kavenegarapi/tab_actions.php'); ?></div>
                          	    <div id="main_settings" class="tab-pane fade"><?php require_once(DIR_APPLICATION.'view/template/extension/module/kavenegarapi/tab_settings.php'); ?></div>
                                <div id="support" class="tab-pane fade"><?php require_once(DIR_APPLICATION.'view/template/extension/module/kavenegarapi/tab_support.php'); ?></div>
                            </div> <!-- /.tab-content --> 
                        </div><!-- /.tabbable -->
                    </form>
            </div> 
