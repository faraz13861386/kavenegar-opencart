<table class="table">
        ...
        <td class="col-xs-9">
            <div class="col-xs-4">
                <div class="form-group" style="padding-top:10px;">
                    <input type="text" id="APIKey" class="form-control" name="KavenegarApi[APIKey]" value="<?php if (isset($data['KavenegarApi']['APIKey'])) {
    echo $data['KavenegarApi']['APIKey'];
} else {
    echo "";
}?>" />
                </div>
	 ...
	 <tr>
        ...
        <td class="col-xs-9">
            <div class="col-xs-4">
                <div class="form-group" style="padding-top:10px;">
                    <input type="text" id="Sender" class="form-control" name="KavenegarApi[Sender]" value="<?php if (isset($data['KavenegarApi']['Sender'])) {
    echo $data['KavenegarApi']['Sender'];
} else {
    echo "";
}?>" />
                </div>
    ...
    <tr>
        ...
        <td class="col-xs-9">
            <div class="col-xs-4">
                <div class="form-group" style="padding-top:10px;">
                    <input type="text" class="form-control" name="KavenegarApi[StoreOwnerPhoneNumber]" value="<?php if (isset($data['KavenegarApi']['StoreOwnerPhoneNumber'])) {
    echo $data['KavenegarApi']['StoreOwnerPhoneNumber'];
} else {
    echo "";
}?>" />
                </div>
