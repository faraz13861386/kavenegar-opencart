...
<div id="" class="form-group clearfix">
    ...
    <div class="col-sm-10">
		<div class="buttons">
            <a id="button-send" onclick="send('index.php?route=extension/module/kavenegarapi/send&token=<?php echo $token; ?>');" class="btn btn-success btn-lg">ارسال پیام</a>
        </div>        
	</div>
</div>
...
<script type="text/javascript">
    ...
    $.ajax({
        url: 'index.php?route=extension/module/kavenegarapi/remaincredit&token=<?php echo $token; ?>',
        type: "POST",
        dataType: 'json',
