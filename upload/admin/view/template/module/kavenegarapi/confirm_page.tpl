    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"> <img src="view/template/module/kavenegarapi/kavenegarapi.logo.small.png" /> <span style="vertical-align:middle;font-weight:bold;"><?php echo $heading_title; ?></span></h3>
            ...
            <div class="panel-body">
    			...
    			<div class="box-heading" style="text-align:center">
                    <h5>This service is provided by <a href="http://kavenegarapi.com" target="_blank"><img src="view/template/module/kavenegarapi/kavenegarapi.logo.png" style="max-height:19px;" /></a></h5>
                </div>
