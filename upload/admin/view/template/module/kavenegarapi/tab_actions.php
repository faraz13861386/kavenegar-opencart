                        ...
                        <div class="tab-content">
                            <?php $class=" active"; foreach ($languages as $language) { ?>
                              <div id="tabOrder-<?php echo $language['language_id']; ?>" language-id="<?php echo $language['language_id']; ?>" class="row-fluid tab-pane<?php echo $class; ?> language">
                                    <br /><textarea rows="3" class="form-control" name="KavenegarApi[CustomerPlaceOrderText][<?php echo $language['language_id']; ?>]"><?php if(!empty($data['KavenegarApi']['CustomerPlaceOrderText'][$language['language_id']])) echo $data['KavenegarApi']['CustomerPlaceOrderText'][$language['language_id']]; else {echo '{SiteName}&#13;';echo'با تشکر برای خرید شما.'.'&#13';echo'شناسه خرید شما'.'&#13';echo '{OrderID}'; }?></textarea>
                              </div>
                            <?php $class="";} ?>
                        </div>
                    </div>
                ...
                <td class="col-xs-10">
                    <div class="col-xs-3">
                        ...
                        <div class="orderStatuses checkbox">
                          <label><input type="checkbox" <?php if(!empty($data['KavenegarApi']['OrderStatusChange']['OrderStatus']) && in_array($order_statuses['order_status_id'], $data['KavenegarApi']['OrderStatusChange']['OrderStatus'])) echo "checked=checked" ?> name="KavenegarApi[OrderStatusChange][OrderStatus][]" value="<?php echo $order_statuses['order_status_id']; ?>"><?php echo $order_statuses['name']; ?></label>
                        </div> <?php } ?>
                        ...
                        <div class="tab-content">
                            <?php $class=" active"; foreach ($languages as $language) { ?>
                              <div id="tabOrderChange-<?php echo $language['language_id']; ?>" language-id="<?php echo $language['language_id']; ?>" class="row-fluid tab-pane<?php echo $class; ?> language">
                                    <br /><textarea rows="3" class="form-control" name="KavenegarApi[OrderStatusChangeText][<?php echo $language['language_id']; ?>]"><?php if(!empty($data['KavenegarApi']['OrderStatusChangeText'][$language['language_id']])) echo $data['KavenegarApi']['OrderStatusChangeText'][$language['language_id']]; else echo ' {Status}. سفارش شما با شناسه خرید ({OrderID})در {SiteName} به وضعیت {Status} بروزرسانی شد'; ?></textarea>
                              </div>
                            <?php $class="";} ?>
                        </div>
                    </div>
                        ...
                        <div class="tab-content">
                            <?php $class=" active"; foreach ($languages as $language) { ?>
                              <div id="tabSignup-<?php echo $language['language_id']; ?>" language-id="<?php echo $language['language_id']; ?>" class="row-fluid tab-pane<?php echo $class; ?> language">
                                    <br /><textarea rows="3" class="form-control" name="KavenegarApi[CustomerRegisterText][<?php echo $language['language_id']; ?>]"><?php if(!empty($data['KavenegarApi']['CustomerRegisterText'][$language['language_id']])) echo $data['KavenegarApi']['CustomerRegisterText'][$language['language_id']]; else echo ''; ?></textarea>
                              </div>
                            <?php $class="";} ?>
                        </div>
                    </div>
    ...
    <div id="customerOrderAdmin" class="tab-pane fade">
        <table class="table">
            ...
            <tr>
                ...
                <td class="col-xs-10">
                    <div class="col-xs-12">
                        <br /><textarea rows="3" class="form-control" name="KavenegarApi[AdminPlaceOrderText]"><?php if(!empty($data['KavenegarApi']['AdminPlaceOrderText'])) echo $data['KavenegarApi']['AdminPlaceOrderText']; else echo 'یک سفارش جدید با شناسه {OrderID}  در فروشگاه  {SiteName} ثبت شد'; ?></textarea>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div id="customerRegisterAdmin" class="tab-pane fade">
        <table class="table">
            ...
            <tr>
                ...
                <td class="col-xs-10">
                    <div class="col-xs-12">
                        <br /><textarea rows="3" class="form-control" name="KavenegarApi[AdminRegisterText]"><?php if(!empty($data['KavenegarApi']['AdminRegisterText'])) echo $data['KavenegarApi']['AdminRegisterText']; else echo 'سلام، {CustomerName} در فروشگاه ثبت نام کرد'; ?></textarea>
                    </div>
                </td>
            </tr>
        </table>
...
$this<span style="color:#00f">-></span>load<span style="color:#00f">-></span>model(<span style="color:#093">'module/KavenegarApi'</span>); <span style="color:#06f;font-style:italic">// Load the model for KavenegarApi </span>
